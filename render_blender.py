...
for i in range(0, args.views):
    ...
    if i==0:
        ...
        directory = "/home/finnz/code/shapenet-pointcloud-generator/test-data/rendered/models/"
        if not os.path.exists(directory):
            os.makedirs(directory)
        np.save(render_file_path + "_intrinsics", intrinsics)
        print("intrinsics\n", intrinsics)
    ...
    obj_matrix_world_inv = obj.matrix_world.inverted()
    print("obj_matrix_world_inv\n", obj_matrix_world_inv)
    ...
    np.save(render_file_path + f"_pose{i}", cam_pose_obj_coord_sys)
    print("cam_pose_obj_coord_sys\n", cam_pose_obj_coord_sys)
